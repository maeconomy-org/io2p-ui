...
// One definition, in `passport-utils`. This file used to declare a second, narrower `PassportFile`
// that drifted from it — same name, different fields, both exported.
export type { PassportFile } from '../utils/passport-utils'
import { isImageFile, type PassportFile } from '../utils/passport-utils'
