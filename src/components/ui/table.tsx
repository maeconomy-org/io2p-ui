...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      'bg-muted text-muted-foreground [&:where(th)]:text-left [&:where(th)]:font-medium [&:where(th)]:px-4 [&:where(th)]:py-2 [&:where([scope=col])]:text-left [&:where([scope=col])]:font-medium [&:where([scope=col])]:px-4 [&:where([scope=col])]:py-2',
      className
    )}
    {...props}
  />
