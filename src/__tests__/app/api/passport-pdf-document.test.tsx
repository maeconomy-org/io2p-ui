...
import { PassportPdfDocument } from '@/app/api/passport/[uuid]/pdf/passport-pdf-document'
import type { PassportPdfDocumentProps } from '@/app/api/passport/[uuid]/pdf/passport-pdf-document'
